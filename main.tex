...
As shown in the Supplementary Material, this filter does not affect inference accuracy but substantially reduces runtime.

We evaluate the performance of \SweepLink against three established single-locus tools:\linebreak\ApproxWF~\citep{ferrer2016}, \diplolocus~\citep{cheng2025}, and \bmws~\citep{mathieson2022}.
...
\SweepLink is launched with 50 grid points for the numerical scheme of the diffusion equation and a discrete selection grid of 13 states for positive selection magnitudes from $0.0$ to $0.06$ with a step size of $0.005$.
...
We extract specific metrics from each tool as scores for the classification task.
...
\SweepLink (blue) is run for 100,000 MCMC samples with an extended version \SweepLink \texttt{(1M)} (light blue) run for 1 million samples.
...
\SweepLink achieved the best MCC score ($0.89$) among tested tools for the extended MCMC chain of 1 million samples and a score of $0.85$ for default chain of 100,000 samples.
...
To explicitly evaluate and compare detection sensitivity specifically for each selection coefficient, we aligned all tools to an identical, highly conservative empirical False Positive Rate (FPR = 0.05\%).
This specific threshold corresponds to the baseline error rate achieved by \SweepLink at the threshold of absolute certainty ($1 - P=10^{-5}$).
...
\begin{table}[htbp]
    ...
    at which all $10^5$ MCMC iterations agreed on the sign of $s$. PP$_4$ is the
    posterior probability that the selection and trait signals share a causal variant.}
    ...
    \begin{tabular}{c r r l l r l r}
        ...
        6  & $29.82$–$29.89$   & $6$   & rs3132714 T\textgreater C$^\dagger$  & HLA-F/HLA-G   & $+0.0181$ & \textit{HLA-F} expression & $0.90$ \\
    ...
    \\[2pt]
    \footnotesize $^{\dagger}$No ancestral allele call at rs3132714; sign of selection is relative to the alternate allele.
\end{table}

\begin{table}[htbp]
    \centering
    \caption{Regions meeting the detection threshold for which no functional
    association could be established. Selection coefficients refer to the derived
    allele, polarised against the Ensembl GRCh37 ancestral reconstruction.
    ``GWAS'' reports the colocalisation posterior and number of studies tested
    where associations existed, and ``none'' where no genome-wide significant
    association was found in any OpenGWAS batch. ``Hapl.'' is the fraction of
    neighbouring loci with correlated frequency trajectories that are also in
    linkage disequilibrium ($r^2>0.2$), a measure of whether the signal is
    carried by a shared haplotype.}
    \label{tab:no_functional_support}
    \resizebox{\columnwidth}{!}{%
    \begin{tabular}{c r r l l r r r l r}
        \toprule
        \textbf{Chr} & \textbf{Region (Mb)} & \textbf{Loci} & \textbf{Target variant} &
        \textbf{Gene} & \textbf{$\hat{s}$} & \textbf{anc.} & \textbf{mod.} &
        \textbf{GWAS} & \textbf{Hapl.} \\
        \midrule
        2  & $37.94$–$38.01$   & $1$ & rs72791933 G\textgreater A  & (CDC42EP3)      & $-0.0099$ & $0.32$ & $0.00$ & none          & $0.00^{\ddagger}$ \\
        2  & $213.76$–$213.82$ & $1$ & rs10498001 C\textgreater T  & --              & $+0.0141$ & $0.12$ & $0.21$ & $0.00$ (8)    & $0.00$ \\
        2  & $221.74$–$221.79$ & $1$ & rs830747 A\textgreater G    & --              & $-0.0126$ & $0.22$ & $0.76$ & none          & $0.17$ \\
        3  & $30.71$–$30.73$   & $1$ & rs3773656 G\textgreater A   & TGFBR2          & $+0.0143$ & $0.75$ & $0.04^{*}$ & none      & $0.00$ \\
        3  & $56.62$–$56.67$   & $1$ & rs282534 G\textgreater A    & CCDC66          & $+0.0195$ & $0.42$ & $0.91$ & $0.00$ (1)    & n/a \\
        4  & $190.64$–$190.69$ & $1$ & rs11132751 A\textgreater G  & --              & $-0.0254$ & $0.74$ & $0.03^{*}$ & none      & $0.00$ \\
        5  & $58.52$–$58.56$   & $1$ & rs66803649 G\textgreater T  & PDE4D           & $+0.0139$ & $0.66$ & $0.01^{*}$ & none      & $0.00$ \\
        9  & $31.07$–$31.12$   & $1$ & rs10813459 C\textgreater T  & --              & $+0.0157$ & $0.64$ & $0.88$ & none          & $\mathbf{0.71}$ \\
        9  & $119.56$–$119.63$ & $3$ & rs200274580 T\textgreater C & ASTN2           & $-0.0142$ & $0.60$ & $0.82$ & none          & $\mathbf{0.33}$ \\
        10 & $55.10$–$55.15$   & $1$ & rs10825008 G\textgreater A  & --              & $+0.0171$ & $0.46$ & $0.71$ & none          & $0.10$ \\
        11 & $7.96$–$7.98$     & $1$ & rs907203 A\textgreater G    & (OR10A3, NLRP10)& $+0.0159$ & $0.05$ & $0.51$ & none          & $0.00^{\ddagger}$ \\
        11 & $9.84$–$9.88$     & $2$ & rs2403221 G\textgreater A   & SBF2            & $+0.0201$ & $0.44$ & $0.79$ & $0.29$ (13)   & $0.11$ \\
        11 & $34.94$–$34.95$   & $1$ & rs2956103 T\textgreater G   & PDHX            & $-0.0105$ & $0.71$ & $0.21$ & none          & $0.17$ \\
        11 & $105.93$–$105.95$ & $1$ & rs10895900 C\textgreater T  & KBTBD3          & $+0.0234$ & $0.20$ & $0.75$ & none          & n/a \\
        12 & $78.30$–$78.35$   & $1$ & rs17817928 T\textgreater G  & NAV3            & $-0.0116$ & $0.29$ & $0.10^{*}$ & none      & $0.00^{\ddagger}$ \\
        12 & $93.06$–$93.10$   & $1$ & rs937754 T\textgreater C    & --              & $-0.0131$ & $0.70$ & $0.92$ & none          & $\mathbf{0.75}$ \\
        14 & $99.75$–$99.76$   & $1$ & rs5013941 G\textgreater T   & (BCL11B)        & $+0.0159$ & $0.73$ & $0.08^{*}$ & none      & $0.00$ \\
        16 & $81.62$           & $1$ & rs4503787 C\textgreater A   & CMIP            & $+0.0336$ & $0.06$ & $0.58$ & $0.50$ (26)   & $0.00$ \\
        \bottomrule
    \end{tabular}%
    }
    \\[3pt]
    \footnotesize
    $^{*}$Modern frequency below $0.10$; association testing in the present-day
    panel had little power at these sites, so absence of a GWAS hit is
    uninformative. \\
    $^{\ddagger}$Seven or more neighbouring loci with correlated trajectories,
    none in linkage disequilibrium — a pattern consistent with a localised
    technical artefact rather than a sweep.
\end{table}
